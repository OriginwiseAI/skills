...
8. Keep the same topic, but switch the result from Knowledge Video to Knowledge Video (Slides).
...
- Do not say bare `video` automatically means `Knowledge Video`; clarify or route through the video family first.
